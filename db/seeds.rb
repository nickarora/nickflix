...
Movie.create!([
  ...
  title: 'Sherlock Holmes',
    description: 
    %{
      Detective Sherlock Holmes and his stalwart partner Watson engage in a 
      battle of wits and brawn with a nemesis whose plot is a threat to 
      all of England.
    }.squish,
    image_file_name: 'sherlock.jpg',
    cast: 'Robert Downey Jr., Jude Law, Rachel McAdams',
    released_on: "2009-12-25",
    duration: '128 min',
    director: 'Jon Favreau',
    rating: 'PG-13',
